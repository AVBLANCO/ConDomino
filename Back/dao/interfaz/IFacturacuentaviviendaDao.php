...
interface IFacturacuentaviviendaDao {
  ...
  public function select($facturacuentavivienda);
    /**
     * Lista todos los objetos Facturacuentavivienda en la base de datos.
     * @return Array<Facturacuentavivienda> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
