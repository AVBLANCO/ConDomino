...
interface IApartamentoDao {
  ...
  public function select($apartamento);
    /**
     * Lista todos los objetos Apartamento en la base de datos.
     * @return Array<Apartamento> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
