...
interface IGastocomunDao {
  ...
  public function select($gastocomun);
    /**
     * Lista todos los objetos Gastocomun en la base de datos.
     * @return Array<Gastocomun> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
