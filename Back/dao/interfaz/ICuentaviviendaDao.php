...
interface ICuentaviviendaDao {
  ...
  public function select($cuentavivienda);
    /**
     * Lista todos los objetos Cuentavivienda en la base de datos.
     * @return Array<Cuentavivienda> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
