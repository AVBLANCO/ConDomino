...
class TipousuarioFacade {
   ...
   */
  public static function insert( $idTipoUsuario,  $descripcionTipoUsuario){
      $tipousuario = new Tipousuario();
      $tipousuario->setIdTipoUsuario($idTipoUsuario); 
      $tipousuario->setDescripcionTipoUsuario($descripcionTipoUsuario); 
   ...
   * @param descripcionTipoUsuario
   */
  public static function update($idTipoUsuario, $descripcionTipoUsuario){
