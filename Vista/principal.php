...
<head>
    ...
    <title>Gestion Condominios | Condominio App</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="../web/img/admin.png" />
                             </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Cortez Jhonathan</strong>
                             </span> <span class="text-muted text-xs block">Administrador<b class="caret"></b></span> </span> </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="profile.html">Perfil</a></li>
                            <li><a href="contacts.html">Contacto</a></li>
                            <li><a href="mailbox.html">Mensajeria</a></li>
                            <li class="divider"></li>
                ...
                <li>
                    <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">Mensajeria</span><span class="label label-warning pull-right">PQRS</span></a>
                ...
                <li>
                    <a href="metrics.html"><i class="fa fa-pie-chart"></i> <span class="nav-label">Informes</span>  </a>
                </li>
                

                <li>
                    <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">Facturacion</span>  <span class="pull-right label label-primary">Especial</span></a>
                    <ul class="nav nav-second-level collapse">
